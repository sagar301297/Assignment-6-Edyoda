...
for(var i=0;i<cards.length;i++)
{
    ...
    cardImgDiv.src=cards[i].imgUrl;
    cardImgDiv.alt=cards[i].imgAlt;
    cardDiv.appendChild(cardImgDiv);

    // create card data div
    var cardContentDiv=document.createElement('div');
    cardContentDiv.classList.add('cardContent');

    var cardHeader = document.createElement('h1');
    cardHeader.classList.add('cardHeader')
    cardHeader.innerText =cards[i].header;

    var cardText = document.createElement('p');
    cardText.classList.add('cardText');
    cardText.innerText = cards[i].description;
    ...
    mainGrid.appendChild(gridItemDiv);
